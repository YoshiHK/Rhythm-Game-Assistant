...
**B. Phase 2 Calibration / Heuristics Configs (runtime: score_calibration_config_v0.2.1.json

(Track C/D tuning configs are handled in Phase 4 and are not part of Phase 2 runtime.)
...
**Phase 2 execution tracks (integrated via runtime routing):**
- Track A: severity enhancement + calibration (config‑driven)
- Track B: selector_v2 (dominance‑aware selection)
- Track C: guidance_engine_v2 (taxonomy‑aware guidance)
- Track D: narrative_module_v2 (spec‑driven narrative)
...
**E. Phase 2 Runtime Spine****E.ates Stage 2–7 execution
- stage_router enforces canonical stage order
- track_router dispatches Track A–D deterministically
- runtime_wrapper provides a stable black‑box entrypoint for Phase 3
