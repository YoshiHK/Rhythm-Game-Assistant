...
// Hook-like helper (framework-agnostic): compute badges from a game entry.
export function useGameBadges(game: GameEntry | null | undefined): GameBadges {
