...
_ADAPTER_MODULES: Dict[str, str] = {
    ...
    "yumesute": "rhythm_ingestion.adapters.game_specific_adapters.adapter_yumesute",
...
def _resolve_adapter_class(game_id: str):
...
def get_adapter(game_id: str) -> Any:
    ...
    cls = _resolve_adapter_class(game_id)
    return cls()
